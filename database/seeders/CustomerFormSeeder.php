...
Липецкой области в соответствии с распоряжением Правительства Российской Федерации от 17 апреля 2019 г. № 768-р.',
		'groups' => [
			...
			[
				'name' => 'Организации предоставляющие товары, работы и услуги',
				'questions' => [
					[
    ...
    public function run() {
		...
		foreach(self::FORM['groups'] as $group) {
			/** @var QuestionGroup $groupModel */
			$groupModel = $form->groups()->create([
				'name' => $group['name']
			]);
			foreach($group['questions'] as $question) {
				...
				$questionModel = $groupModel->questions()->create([
					'type' => $type
				]);
